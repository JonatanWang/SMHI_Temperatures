...
public class JSONParser {
    ...
    private String getParameters() throws IOException, JSONException {
        ...
        //JSONObject parameterObject = readJsonFromUrl(metObsAPI + "/version/1.0/parameter/1/station/159880/period/latest-months/data.json");
        //JSONArray parametersArray = parameterObject.getJSONArray("resource");
    ...
    public JSONObject getStationJsonObject() throws IOException, JSONException{

        return readJsonFromUrl(metObsAPI + "/version/latest/parameter/" + getParameters() + ".json");
    }

    public JSONObject getPeriodJsonObject() throws IOException, JSONException {

        return readJsonFromUrl(metObsAPI + "/version/latest/parameter/" + getParameters() + "/station/" + getStationNames(getParameters()) + ".json");
    }
